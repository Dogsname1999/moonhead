...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;margin:0 auto;">
  ...
  <tr><td align="center" style="padding:0 0 40px;"><a href="https://www.tourbustix.com/pastshow" style="display:inline-block;padding:16px 48px;border-radius:999px;font-size:18px;font-weight:700;color:#F5F0E8;background-color:#2C4A6E;text-decoration:none;letter-spacing:0.02em;">Start Tracking Your Shows</a></td></tr>
  <tr><td style="padding:0 0 40px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-left:3px solid #5C7A9E;"><tr><td style="padding:0 0 0 20px;"><p style="margin:0 0 12px;font-size:15px;color:#2C4A6E;line-height:1.6;">Hey! Welcome to Tourbus Tix. We developed this platform for people who love live music. As the physical ticket stub becomes a thing of the past, this tool helps you track your shows and setlists. You can also find upcoming shows and grab tickets.</p><p style="margin:0;font-size:15px;font-weight:600;color:#2C4A6E;">&mdash; Luke</p></td></tr></table></td></tr>
